...
const firebaseConfig = { // configuraciones para conectarse a la base de datos de Firebase adecuada
    ...
    projectId: "tattoobookings-6f167", // dio error al intentar usar process.env.FIREBASE_PROJECT_ID(FirebaseError: projectId must be a string in FirebaseApp.options)
